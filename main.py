...
myconn = mysql.connector.connect(host = "localhost", user = "root",passwd = mysqlPassword,database="cs207_healthcare_management", auth_plugin=mysqlPassword,buffered=True)
